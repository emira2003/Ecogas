...
const h1For = (town: string) => `Boiler replacement, servicing and heating in ${town}`;
const metaTitleFor = (town: string) => `Boiler Replacement & Heating in ${town} | Eco Gas`;
...
export const areas: Area[] = [
  {
    ...
    map: { x: 357, y: 246 },
    intro: [
      "Eco Gas is based on Plodder Lane in Bolton, so most of our work is within a few miles of home: Westhoughton and Over Hulton on our doorstep, Farnworth and Kearsley to the east, Horwich and Bromley Cross to the north, and everything in between. Bolton’s housing is a mix of stone and red-brick terraces, 1930s semis and newer estates, and since 2000 we’ve fitted boilers and heating systems in all of them.",
      "Because we’re local, a free look at the job is easy to arrange and there’s no long wait for a price. Landlords with properties around the town centre and the university use us for their annual gas safety certificates, and homeowners across the BL postcodes call us for everything from an annual service to a full new heating system. New boilers start from £1,625, with a warranty that comes from the boiler manufacturer.",
    ],
    travelNote: "Our home patch. Every BL postcode is close to our base on Plodder Lane.",
    h1: h1For("Bolton"),
    metaTitle: metaTitleFor("Bolton"),
    metaDescription:
      "Gas Safe boiler replacement, central heating and servicing across Bolton, Westhoughton, Farnworth and Horwich. Based on Plodder Lane, trading since 2000.",
  },
  {
    slug: "manchester",
    town: "Manchester",
  ...
  },
  {
    ...
    intro: [
      ...
      "Robin, one of our Stockport customers, had us relocate his boiler and change the pipework, and left a five-star review. That kind of job, moving a boiler to a better spot, is one we do a lot here. We also fit new boilers from £1,625, with a warranty that comes from the boiler manufacturer, service and repair existing ones, and provide landlord gas safety certificates.",
    ],
  ...
  },
  {
    ...
    intro: [
      ...
      "Being so close means a free look at the job is easy to fit in, and a like-for-like boiler swap is usually done in a day. New boilers start from £1,625, with a warranty that comes from the boiler manufacturer; we also fit full heating systems, service and repair boilers and provide landlord gas safety certificates for Wigan’s many rented terraces.",
    ],
  ...
  },
  {
    ...
    intro: [
      ...
      "We replace boilers from £1,625, with a warranty that comes from the boiler manufacturer, fit full heating systems and radiators, service and repair existing boilers, and provide landlord gas safety certificates for Preston’s student and family rentals. As with every town we cover, the price is confirmed after a free look at the job, and we tell you how long the work will take before we start.",
    ],
